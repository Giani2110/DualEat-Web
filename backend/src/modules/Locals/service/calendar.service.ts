import { PrismaClient, LocalCalendarEvent, LocalNote, LocalEventType, EventStatus } from '@prisma/client';
const prisma = new PrismaClient();

// LÓGICA DE EVENTOS DE CALENDARIO
export const getEventsByLocal = async (localId: string, startDate: Date, endDate: Date) => {
...
export const updateNote = async (noteId: string, data: Partial<LocalNote>): Promise<LocalNote> => {
