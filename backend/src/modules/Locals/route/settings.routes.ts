...
router.get("/:localId", SettingsController.getLocalSettings);

router.put("/:localId", SettingsController.updateLocalSettings);

router.get("/:localId/schedule", SettingsController.getLocalSchedules);

router.put("/:localId/schedule", SettingsController.updateLocalSchedules);
