...
const RegisterLocal = () => {
  ...
  const handleStep2 = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(
          data.message || "Error al completar el perfil del local",
        );
      }
        ...
        children2={
          <div className="mt-4 flex flex-col justify-center gap-3 w-full text-center items-center">
            <Link
              ...
              className="text4 hover:text-red-500 underline font-bold px-4 py-2"
            >
              Volver al Inicio
            </Link>
          </div>
      ...
      >
        <div className="flex flex-col gap-4 text-left">
          <p className="text-[16px] text4 leading-relaxed bg-white/50 p-4 rounded-xl border border-gray-100">
            Hemos registrado su comercio de forma correcta. Actualmente se
            encuentra con el estado{" "}
            <strong className="text-red-600">Pendiente de Aprobación</strong>.
            <br />
            <br />
            Un administrador de DualEat revisará su solicitud pronto. Podrá
            iniciar sesión una vez que el estado de su local pase a ser aprobado
            y activo.
          </p>
        </div>
      </AuthSection>
  ...
  return (
    ...
    >
      ...
      >
        <div className="mt-3">
          <p className="font-medium text-[15px] mb-2 text5 text-left">
