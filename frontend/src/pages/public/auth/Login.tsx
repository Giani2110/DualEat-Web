    ...
    >
      ...
      >
        <div className="space-y-2">
          <div className="font-medium text-[16px] text5">Email</div>
          <input
            required={step === 1}
            readOnly={step === 2}
            type="email"
        ...
        <div className="flex items-center gap-x-2">
          ...
          />
          <span className="text-[15px] text-text-5">Recuérdame</span>
        </div>

        {step === 2 && (
          <div className="space-y-4">
            <div className="flex flex-col gap-y-2">
              <div className="font-medium text-[16px] text-text-5">
                Contraseña
              </div>

              <div className="flex flex-row items-center justify-between border border-gray-300 rounded-lg focus:ring-1 focus:ring-[#B2B2B2] focus:border-transparent px-4">
                <input
                  required
            ...
            <div className="flex items-center justify-between">
              <Link
                ...
                className="text-text-5 font-normal text-[16px] cursor-pointer underline hover:scale-102 transition-transform"
              >
              ...
              >
                <span className="text-text-5 text-[16px] underline">
                  Volver
                </span>
              </button>
            </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full flex gap-x-2 items-center justify-center text-text-3 text-[16px] cursor-pointer border border-dashed border-bg-red hover:bg-[#B53325] hover:text-text-1 py-[12px] rounded-lg transition-colors font-medium"
        >
          {step === 1
            ? "Siguiente"
            : loading
