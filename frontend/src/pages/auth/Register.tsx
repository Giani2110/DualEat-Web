  ...
  return (
    <div className="min-h-screen flex bg-gray">
      ...
      <div className=" lg:w-1/2  flex flex-col justify-center p-8 max-w-[620px] mx-auto w-full">
        ...
        <div className="mb-[60px]">
          <div className="flex justify-center mb-6">
            <div className="w-[60px] h-[60px] bg-yellow rounded-lg flex items-center justify-center">
              <img
                src={LogoDualEat}
                alt="DualEat Logo"
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex cursor-pointer text-[15px] items-center justify-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
            >
            ...
            <button
              ...
              className="flex text-[15px] items-center justify-center px-4 py-2 border border-gray-300 cursor-pointer rounded-lg hover:bg-gray-50 transition-colors"
            >
              <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                <path
                  fill="#000000"
      ...
      <div className="w-full lg:w-1/2 relative overflow-hidden">
        ...
        {imagesPreloaded ? (
          <div
            className="right-background absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out"
            style={{
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full">
          <div className="Dform-right px-[50px] py-[70px] flex flex-col">
            <div className="flex flex-col items-end mb-6">
              <img
                src={LogoDualEat}
                alt="DualEat Logo"
                className="w-[50px] h-auto mb-[40px] text-right"
              />
              <h1 className="text-[18px] text2">Bienvenido/a a</h1>
              <h2 className="text-[36px] text-white font-bold mb-3">DualEat</h2>
              <p className="text-[16px] text-right text2">
