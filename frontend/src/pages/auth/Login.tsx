...
  useEffect(() => {
    if (imagesPreloaded) { // Solo inicia el carrusel una vez que las imágenes están precargadas
...
          <div
            className="bg-black bg-opacity-20 backdrop-blur-xs p-8 rounded-l-3xl flex flex-col justify-between"
            style={{
