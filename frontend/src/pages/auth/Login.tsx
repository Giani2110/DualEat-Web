...
const Login: React.FC = () => {
  ...
  }, [images.length, imagesPreloaded, currentImageIndex]);
  ...
  return (
    <div className="min-h-screen flex-col lg:flex-row flex bg-gray">
      ...
      <div className="w-full lg:w-1/2 relative overflow-hidden">
        ...
        {imagesPreloaded ? (
          <div
            className="left-background absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out"
            style={{
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full">
          <div className="Dform px-[50px] py-[70px] flex flex-col">
            <div>
              <img
                src={LogoDualEat}
                alt="DualEat Logo"
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center max-w-[620px] mx-auto p-8 relative">
        <Link to={"/"}>
        ...
        <div className="mb-[60px]">
          <div className="flex justify-center mb-6">
            <div className="w-[60px] h-[60px] bg-red rounded-lg flex items-center justify-center">
              <img
                src={LogoDualEat}
                alt="DualEat Logo"
