...
export default function ChatScreen() {
  ...
  return (
    <main className="relative p-4 flex-1 gap-y-3 flex flex-col items-center h-full w-full bg-bg-semi-white">
      ...
      <header className="w-full flex flex-row items-center justify-between z-10">
        <button
          type="button"
          onClick={() => {
            setType("Recetas");
      ...
      {!chat ? (
        ...
        <section style={{ paddingBottom: "8vh"}} className="w-full h-full justify-center items-center flex flex-col overflow-hidden">
          ...
          <div className="w-full p-4 max-w-[90vw] lg:max-w-[1000px] fixed bottom-0">
            <MessageInput
              message={message}
              isPending={isPending}
              setMessage={setMessage}
