      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-3 border-t border-gray-700">
          <button
            ...
            className="group flex items-center w-full px-3 py-3 text-sm font-medium text-gray-400 hover:bg-red-900/40 hover:text-red-400 rounded-xl transition-all duration-200"
          >
