...
import { AlignJustify, LogOut, ChevronUp, Plus } from "lucide-react";
    ...
    <>
      <div className="flex flex-col">
        ...
        >
          {location.pathname === ROUTES.USER.DASHBOARD ? (
            <>
              {HOME_ICON_FILLED}
              <span className={`ml-3 text4 text-[15px] Dosis-Bold text3`}>
                Inicio
              </span>
            </>
          ) : (
        ...
        >
          {location.pathname === ROUTES.USER.RECIPES ? (
            <>
              {RECIPES_ICON_FILLED}
              <span className={`ml-3 text4 text-[15px] Dosis-Bold`}>
                Recetas
              </span>
            </>
          ) : (
            <>
              {RECIPES_ICON_OUTLINE}
        ...
        <div
          ...
          className={` transition-all duration-300 cursor-pointer w-full py-[10px] overflow-hidden ${
            communityOpen ? "h-fit" : "h-[55px]"
          }
          `}
        >
          <div
            className={`flex justify-between px-3 items-center rounded-[8px] hover:bg-[#e9e9e9] py-[10px]`}
          >
            {isSidebarOpen && (
              <>
                <span
                  className={`ml-2 text-left text-[15px] text5`}
                >
                  Comunidades
                </span>
                <ChevronUp
          ...
          {communityOpen && (
            <>
              <button
                ...
                type="button"
                className={`navlis rounded-[8px] cursor-pointer w-full py-[8px] ${
              ...
              >
                ...
                />
                <span
                  className={`ml-[14px] text4 text-[14px] whitespace-nowrap ${
              ...
              {userCommunities.map((community) => (
                <Link
                  ...
                  className={`navlis flex-[1] rounded-[8px] cursor-pointer w-full py-[4px] hover:bg-[#e9e9e9] px-4`}
                >
                  <img
                    src={
        ...
        <div
          ...
          className={`transition-all duration-300 w-full py-2 cursor-pointer overflow-hidden ${
            following ? "h-fit" : "h-[55px]"
          }     
          `}
        >
          <div
            className={`flex justify-between px-3 items-center rounded-[8px] ${
      ...
      <div>
        ...
        <button
          ...
          className={`navlis w-full rounded-[8px] group cursor-pointer px-2 py-3 ${
            isSidebarOpen ? "hover:bg-[#e9e9e9] block" : "hidden"
          }`}
        >
          <LogOut
            color="#b53325"
