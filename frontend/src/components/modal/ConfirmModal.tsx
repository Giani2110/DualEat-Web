...
const ConfirmModal: React.FC<ConfirmModalProps> = ({
    ...
    const getIcon = () => {
        switch (type) {
            ...
            case 'warning': return <FaExclamationTriangle className="text-amber-500 text-3xl" />;
            case 'success': return <FaCheckCircle className="text-emerald-500 text-3xl" />;
            default: return <FaInfoCircle className="text-blue-500 text-3xl" />;
        }
    };
                    ...
                    <div className="fixed inset-0 flex items-center justify-center z-[9999] p-4 pointer-events-none">
                        ...
                        >
                            <div className="relative p-8 flex flex-col items-center text-center">
                                ...
                                {/* Icon */}
                                <div className={`mb-6 w-20 h-20 rounded-3xl flex items-center justify-center ${type === 'danger' ? 'bg-red-50' :
                                ...
                                {/* Actions */}
                                <div className={`flex w-full gap-3 ${isAlert ? 'justify-center' : ''}`}>
                                    {!isAlert && (
                                        <button
                                            onClick={onClose}
