          ...
          {location.pathname !== "/onboarding" && (
            <>
              <div className="flex w-full items-center justify-around mb-5 mt-6">
                ...
                <span className="px-2 text-[14.5px] text6">O continúa con</span>
              ...
              <div>
                <button
                  ...
                  className="flex w-full text-[15px] mb-[40px] text5 items-center cursor-pointer justify-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
                >
